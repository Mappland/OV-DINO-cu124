...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 https_proxy=http://127.0.0.1:8890 http_proxy=http://127.0.0.1:8890 all_proxy=http://127.0.0.1:8890 bash scripts/finetune.sh \
