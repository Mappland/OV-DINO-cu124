...
def generate_meta_info(coco_json_path):
    ...
    if not categories:
        raise ValueError(
            "JSON 文件中未找到 'categories' 字段，请检查文件格式是否正确。"
        )

    # 初始化 meta_info
    meta_info = {"thing_dataset_id_to_contiguous_id": {}, "thing_classes": []}
...
def register_custom_datasets(
    meta_info, train_annotations, train_images, val_annotations, val_images
):
    """
    注册自定义的训练和验证数据集。
...
if __name__ == "__main__":
    ...
    coco_json_path = (
        "/home/mappland/project/OV-DINO/all_data4/english-data-25-5-10.json"
    )
    ...
    train_images = "/home/mappland/project/OV-DINO/all_data4"
    val_annotations = (
        "/home/mappland/project/OV-DINO/all_data4/english-data-25-5-10.json"
    )
    val_images = "/home/mappland/project/OV-DINO/all_data4"
